        ...
        <div class="container">
            <div class="card mb-3">
                <div class="card-body">
                  ...
                  <p class="card-text">Welcome to our project. Find below a quick presentation of the project.</p>
                  <div class="d-flex flex-wrap align-self-start justify-content-center">
                    <div class="card" style="width:320px; margin:10px; max-height:500px;" class="row">
                      <!-- le corps -->
                        <div class="card-body">
                          <h4 class="card-title">Feature</h4>
                          <div class="card-text" style ="min-height: 52px; overflow: hidden; margin-bottom: 10px; text-align: justify" >
                            <ul>
                              <li>You embody a spaceship</li>
                              <li>You must defend yourself from dinosaurs attacking you.</li>
                              <li>You earn points by hitting enemies with your laser.</li>
                              <li>You travel through space and discover wonderful landscapes.</li>
                            </ul>
                          </div>
                        </div>
                    </div>
                      ...
                      <!-- le corps -->
                        <div class="card-body">
                          ...
                          <div class="card-text" style ="min-height: 52px; max-height: 52px; overflow: hidden; margin-bottom: 10px;" >
                            This project is licensed under the MIT License - see the <a style="color:white;"href="https://github.com/dylan-power/dinosaur-exploder/blob/main/LICENSE">LICENSE.md</a> file for details.
                          </div>
                        </div>
                    </div>
                    <div class="card" style="width:320px; margin:10px; max-height:500px;" class="row">
                      <!-- le corps -->
                        <div class="card-body">
                          ...
                          <div class="card-text" style ="min-height: 52px; max-height: 300px; overflow: hidden; margin-bottom: 10px; text-align: justify" >
                            <p>Thank you for showing interest in contributing to our game and community. If you want an overview of this project, please refer to <a href="https://github.com/dylan-power/dinosaur-exploder/blob/main/README.md">README.md</a>.
                              Before contributing, please read our <a href="https://github.com/dylan-power/dinosaur-exploder/blob/main/CODE_OF_CONDUCT.md">Code of Conduct</a> along with this document. 
                              If you don't have git set up on your machine, please <a href="https://docs.github.com/en/get-started/quickstart/set-up-git">follow this guide</a>.
                              If you haven't developed using JavaFX and FXGL, please <a href="https://www.youtube.com/watch?v=48rVgdq0mFA">watch this video</a>.</p>
                          </div>
                        </div>
                    </div>
      ...
      <div class="container">
          <div class="card mb-3">
              <div class="card-body">
                ...
                <button type="button" onclick="window.open('mailto:dinosaurexploder.conduct@gmail.com')" class="btn btn-danger my-2">
