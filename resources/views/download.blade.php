					...
					<div class="tab-pane fade" id="pills-local" role="tabpanel" aria-labelledby="pills-local-tab">
						<div class="card text-center" style="padding: 20px">
							<div class="card-body">
							  ...
							  <p class="lead">
								To install our project locally, <kbd>fork</kbd> our repository, and in an empty directory, <br> type the following command:
							  </p>
							  <code>$ git clone git@github.com: *user*/dinosaur-exploder.git</code><br>
							  <a href="https://github.com/dylan-power/dinosaur-exploder" target="_blank" class="btn btn-dark" style="margin-top: 20px">
